...
public class ActualContactsAfterDeletion implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        List<String> expectedContactList = Arrays.asList("Ana Maria","Pepito Perez");

        return actualContactList.equals(expectedContactList);
    }

    public static ActualContactsAfterDeletion actualContacts(){
        return new ActualContactsAfterDeletion();
    }
}
