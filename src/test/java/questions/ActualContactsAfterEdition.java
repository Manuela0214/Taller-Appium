...
public class ActualContactsAfterEdition implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        List<String> expectedContactList = Arrays.asList("Ana Maria","Juan David","Pepito Perez");

        return actualContactList.equals(expectedContactList);
    }

    public static ActualContactsAfterEdition actualContacts(){
        return new ActualContactsAfterEdition();
    }
}
